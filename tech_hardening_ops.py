...
Split from tech_hardening.py to keep every module under the PyArmor
per-file license limit (AGENTS.md rule 6b).
"""
...
from tech_hardening import _log_path, _redact, _install_safe_mode_ui
