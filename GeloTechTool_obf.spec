...
a = Analysis(
    ...
    datas=[('scrcpy-win64-v3.3.4.zip', '.'), ('ApkIconHelper.apk', '.'), ('banking_apps.json', '.'), ('gelotech_icon.ico', '.'), ('tech_phone_mirror.py', '.'), ('assets', 'assets'), ('themes', 'themes')],
    hiddenimports=['customtkinter', 'PIL', 'PIL.Image', 'PIL.ImageDraw', 'PIL.ImageFont', 'PIL.ImageTk', 'requests',
                   ...
                   'cryptography', 'cryptography.hazmat.primitives.asymmetric.ed25519',
                    'tech_common', 'tech_ui', 'tech_settings', 'tech_settings_login', 'techtool_core', 'tech_admin', 'tech_reg', 'tech_secscan',
                    'tech_secops', 'tech_secops3', 'tech_secops2', 'tech_secops4', 'tech_bloatware', 'tech_dash', 'tech_vtop', 'tech_misc',
                   ...
                   'tech_themes', 'sitecustomize', 'importlib', 'importlib.util', 'inspect', 'pathlib'],
    hookspath=[],
    hooksconfig={},
