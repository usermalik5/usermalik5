...
MODULES = [
    ...
    "tech_qt_final_fixes.py", "tech_qt_help_pages.py", "tech_qt_iconfix.py", "tech_qt_icons.py",
    "tech_qt_iconsync.py", "tech_qt_mainwindow.py", "tech_qt_mirror.py", "tech_qt_phone.py",
    "tech_qt_sidebar_compact.py", "tech_qt_themes.py", "tech_qt_ui.py", "tech_qt_virustotal.py",
    "tech_qt_visual_polish.py",
]
